...
const Slides = class {
  constructor(hostRef) {
    ...
    this.ionSlidesDidLoad = index.createEvent(this, "ionSlidesDidLoad", 7);
    this.ionSlideTap = index.createEvent(this, "ionSlideTap", 7);
    this.ionSlideDoubleTap = index.createEvent(this, "ionSlideDoubleTap", 7);
    this.ionSlideWillChange = index.createEvent(this, "ionSlideWillChange", 7);
    this.ionSlideDidChange = index.createEvent(this, "ionSlideDidChange", 7);
    this.ionSlideNextStart = index.createEvent(this, "ionSlideNextStart", 7);
    this.ionSlidePrevStart = index.createEvent(this, "ionSlidePrevStart", 7);
    this.ionSlideNextEnd = index.createEvent(this, "ionSlideNextEnd", 7);
    this.ionSlidePrevEnd = index.createEvent(this, "ionSlidePrevEnd", 7);
    this.ionSlideTransitionStart = index.createEvent(this, "ionSlideTransitionStart", 7);
    this.ionSlideTransitionEnd = index.createEvent(this, "ionSlideTransitionEnd", 7);
    this.ionSlideDrag = index.createEvent(this, "ionSlideDrag", 7);
    this.ionSlideReachStart = index.createEvent(this, "ionSlideReachStart", 7);
    this.ionSlideReachEnd = index.createEvent(this, "ionSlideReachEnd", 7);
    this.ionSlideTouchStart = index.createEvent(this, "ionSlideTouchStart", 7);
    this.ionSlideTouchEnd = index.createEvent(this, "ionSlideTouchEnd", 7);
  ...
  async initSwiper() {
    ...
    // init swiper core
    // @ts-ignore
    const { Swiper } = await Promise.resolve().then(function () { return require('./swiper.bundle-cbea42d8.js'); });
  ...
  render() {
    ...
    return (index.h(index.Host, { class: {
      ...
      } }, index.h("div", { class: "swiper-wrapper" }, index.h("slot", null)), this.pager && index.h("div", { class: "swiper-pagination", ref: el => this.paginationEl = el }), this.scrollbar && index.h("div", { class: "swiper-scrollbar", ref: el => this.scrollbarEl = el })));
  }
