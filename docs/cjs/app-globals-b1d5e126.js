...
const patchEsm = () => {
    ...
    if ( !(index.CSS && index.CSS.supports && index.CSS.supports('color', 'var(--c)'))) {
        // @ts-ignore
        return Promise.resolve().then(function () { return require(/* webpackChunkName: "polyfills-css-shim" */ './css-shim-71a46228.js'); }).then(() => {
...
const patchBrowser = () => {
    ...
    }
    {
        ...
        if ( !index.win.customElements) {
            ...
            // @ts-ignore
            return Promise.resolve().then(function () { return require(/* webpackChunkName: "polyfills-dom" */ './dom-3cba5278.js'); }).then(() => opts);
        }
    }
