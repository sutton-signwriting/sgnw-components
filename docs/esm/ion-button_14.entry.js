import { r as registerInstance, c as createEvent, h as h$1, H as Host, a as getElement, f as forceUpdate, d as getAssetPath, e as readTask, w as writeTask } from './index-f39b07ed.js';
import { g as getIonMode$1 } from './ionic-global-0c7dacfa.js';
import { r as rgba2hex, a as rgb2hex } from './global-f1347002.js';
import { h as hasShadowDom, i as inheritAttributes, d as debounceEvent, f as findItemLabel, r as raf, c as clamp, a as renderHiddenInput } from './helpers-aef58b6d.js';
import { o as openURL, c as createColorClasses$1, h as hostContext } from './theme-12606872.js';
import { u as u$1, d as d$1, e as e$1, x as x$1, b as b$1, l as l$1, g as g$1, m as m$1, t as t$1, w as w$1 } from './fsw.min-4bd478f1.js';
...
const Button = class {
  ...
  render() {
    ...
    return (h$1(Host, { onClick: this.handleClick, "aria-disabled": disabled ? 'true' : null, class: createColorClasses$1(color, {
        [mode]: true,
        [buttonType]: true,
...
const Card = class {
  ...
  renderCard(mode) {
    ...
    return (h$1(TagType, Object.assign({}, attrs, { class: "card-native", part: "native", disabled: this.disabled, onClick: (ev) => openURL(href, ev, routerDirection, routerAnimation) }), h$1("slot", null), clickable && mode === 'md' && h$1("ion-ripple-effect", null)));
  }
  render() {
    const mode = getIonMode$1(this);
    return (h$1(Host, { class: createColorClasses$1(this.color, {
        [mode]: true,
  ...
  render() {
    ...
    const flipRtl = this.flipRtl ||
      (this.ariaLabel &&
        ...
        this.flipRtl !== false);
    return (h$1(Host, { role: "img", class: Object.assign(Object.assign({ [mode]: true }, createColorClasses(this.color)), { [`icon-${this.size}`]: !!this.size, 'flip-rtl': !!flipRtl && this.el.ownerDocument.dir === 'rtl' }) },  this.svgContent ? (h$1("div", { class: "icon-inner", innerHTML: this.svgContent })) : (h$1("div", { class: "icon-inner" }))));
  }
...
const Item = class {
  ...
  render() {
    ...
    return (h$1(Host, { "aria-disabled": disabled ? 'true' : null, class: Object.assign(Object.assign(Object.assign({}, childStyles), labelColorStyles), createColorClasses$1(this.color, {
        'item': true,
        [mode]: true,
        ...
        'ion-focusable': true,
      })) }, h$1(TagType, Object.assign({}, attrs, { class: "item-native", part: "native", disabled: disabled }, clickFn), h$1("slot", { name: "start" }), h$1("div", { class: "item-inner" }, h$1("div", { class: "input-wrapper" }, h$1("slot", null)), h$1("slot", { name: "end" }), showDetail && h$1("ion-icon", { icon: detailIcon, lazy: false, class: "item-detail-icon", part: "detail-icon" }), h$1("div", { class: "item-inner-highlight" })), canActivate && mode === 'md' && h$1("ion-ripple-effect", null)), h$1("div", { class: "item-highlight" })));
  }
...
const Range = class {
  ...
  render() {
    ...
    return (h$1(Host, { onFocusin: this.onFocus, onFocusout: this.onBlur, class: createColorClasses$1(this.color, {
        [mode]: true,
        'in-item': hostContext('ion-item', el),
        'range-disabled': disabled,
        'range-pressed': pressedKnob !== undefined,
        'range-has-pin': pin
      }) }, h$1("slot", { name: "start" }), h$1("div", { class: "range-slider", ref: rangeEl => this.rangeSlider = rangeEl }, ticks.map(tick => (h$1("div", { style: tickStyle(tick), role: "presentation", class: {
        'range-tick': true,
        'range-tick-active': tick.active
      }, part: tick.active ? 'tick-active' : 'tick' }))), h$1("div", { class: "range-bar", role: "presentation", part: "bar" }), h$1("div", { class: "range-bar range-bar-active", role: "presentation", style: barStyle, part: "bar-active" }), renderKnob(isRTL, {
      knob: 'A',
...
const renderKnob = (isRTL, { knob, value, ratio, min, max, disabled, pressed, pin, handleKeyboard }) => {
  ...
  return (h$1("div", { onKeyDown: (ev) => {
    ...
    }, style: knobStyle(), role: "slider", tabindex: disabled ? -1 : 0, "aria-valuemin": min, "aria-valuemax": max, "aria-disabled": disabled ? 'true' : null, "aria-valuenow": value }, pin && h$1("div", { class: "range-pin", role: "presentation", part: "pin" }, Math.round(value)), h$1("div", { class: "range-knob", role: "presentation", part: "knob" })));
};
...
const RippleEffect = class {
  ...
  render() {
    const mode = getIonMode$1(this);
    return (h$1(Host, { role: "presentation", class: {
        [mode]: true,
...
const Row = class {
  ...
  render() {
    return (h$1(Host, { class: getIonMode$1(this) }, h$1("slot", null)));
  }
};
Row.style = rowCss;
...
const SgnwSymbol = class {
  ...
  fswUpdate(newValue, oldValue) {
    ...
    if (tooLong) {
      ...
      if (newValue != oldValue) {
        ...
        if (fsw && fsw.symbol) {
          this.fsw = fsw.symbol;
          this.iid = x$1(fsw.symbol);
          this.swu = b$1(fsw.symbol);
        }
      }
    }
  }
  swuUpdate(newValue, oldValue) {
    if (newValue != oldValue) {
      ...
      if (swu && swu.symbol) {
        this.iid = g$1(swu.symbol);
        this.fsw = m$1(swu.symbol);
      }
    }
  }
  connectedCallback() {
  ...
  render() {
    ...
    if (this.styling) {
      ...
      styleStr = t$1(styleObj);
    }
    //var svgSize = parseFloat(window.getComputedStyle(this.el).getPropertyValue("font-size").slice(0,-2))/30;
    return (h$1(Host, { iid: this.iid, fsw: this.fsw, swu: this.swu, styling: this.styling, innerHTML: this.sgnw ? w$1(this.fsw + (styleStr)) : '' }, h$1("slot", null)));
  }
  get el() { return getElement(this); }
  static get watchers() { return {
    "iid": ["iidUpdate"],
...
const SgnwSymbolPicker = class {
  ...
  render() {
    return (h$1(Host, null, h$1("ion-card", null, h$1("ion-item", null, h$1("ion-range", { name: "kind", value: this.kind, onIonFocus: () => this.focusChanged('kind'), onIonChange: this.rangeChanged, min: 0, max: 2, snaps: true }, h$1("ion-label", { slot: "start" }, "Kind"))), h$1("ion-item", null, h$1("ion-range", { name: "category", value: this.category, onIonFocus: () => this.focusChanged('category'), onIonChange: this.rangeChanged, min: 0, max: 6, snaps: true }, h$1("ion-label", { slot: "start" }, "Category"))), h$1("ion-item", null, h$1("ion-range", { name: "group", value: this.group, onIonFocus: () => this.focusChanged('group'), onIonChange: this.rangeChanged, min: 0, max: 29, snaps: true }, h$1("ion-label", { slot: "start" }, "Group"))), h$1("ion-item", null, h$1("ion-range", { name: "base", value: this.base, onIonFocus: () => this.focusChanged('base'), onIonChange: this.rangeChanged, min: 0, max: 651, snaps: true }, h$1("ion-label", { slot: "start" }, "Base"))), h$1("ion-grid", null, h$1("ion-row", null, h$1("ion-col", { size: "4" }), h$1("ion-col", { size: "2" }, h$1("ion-button", { expand: "block", onClick: () => this.symbolMod('base', 1) }, h$1("ion-icon", { name: "caret-up-outline" }))), h$1("ion-col", { size: "2" }, h$1("ion-button", { expand: "block", onClick: () => this.symbolMod('fill', 1) }, h$1("ion-icon", { name: "caret-up-outline" }))), h$1("ion-col", { size: "2" }, h$1("ion-button", { expand: "block", onClick: () => this.symbolMod('rotation', 1) }, h$1("ion-icon", { name: "caret-up-outline" })))), h$1("ion-row", null, h$1("ion-col", { size: "4" }), h$1("ion-col", { size: "2" }, h$1("ion-button", { expand: "block", onClick: () => this.symbolMod('base', -1) }, h$1("ion-icon", { name: "caret-down-outline" }))), h$1("ion-col", { size: "2" }, h$1("ion-button", { expand: "block", onClick: () => this.symbolMod('fill', -1) }, h$1("ion-icon", { name: "caret-down-outline" }))), h$1("ion-col", { size: "2" }, h$1("ion-button", { expand: "block", onClick: () => this.symbolMod('rotation', -1) }, h$1("ion-icon", { name: "caret-down-outline" })))), h$1("ion-row", null, h$1("ion-col", { size: "4" }, h$1("ion-title", null, "Symbol")), h$1("ion-col", { size: "6" }, d.symbolSize(this.iid)
      ? h$1("sgnw-symbol", { fsw: this.fsw, styling: "-CZ2" })
      : h$1("ion-title", null, "invalid symbol"))), h$1("ion-row", null, h$1("ion-col", { size: "4" }, h$1("ion-title", null, "FSW")), h$1("ion-col", { size: "6" }, h$1("ion-input", { id: "fsw-input", name: "fsw-input", type: "text", pattern: fsw_min.re.symbol, onIonFocus: () => this.focusChanged('fsw-input'), value: this.fsw })), h$1("ion-col", { size: "2" }, h$1("ion-button", { onClick: () => { this.setSymbol("fsw", this.element.shadowRoot.querySelector('ion-input#fsw-input').value); } }, "Set"))), h$1("ion-row", null, h$1("ion-col", { size: "4" }, h$1("ion-title", null, "SWU")), h$1("ion-col", { size: "6" }, h$1("ion-input", { class: "swu", id: "swu-input", name: "swu-input", type: "text", pattern: swu_min.re.symbol, onIonFocus: () => this.focusChanged('swu-input'), value: this.swu })), h$1("ion-col", { size: "2" }, h$1("ion-button", { onClick: () => { this.setSymbol("swu", this.element.shadowRoot.querySelector('ion-input#swu-input').value); } }, "Set"))), h$1("ion-row", null, h$1("ion-col", { size: "4" }, h$1("ion-title", null, "SWU Hex")), h$1("ion-col", { size: "6" }, h$1("ion-input", { id: "swuhex-input", name: "swuhex-input", type: "text", pattern: "0x4[0-9a-f]{4}", onIonFocus: () => this.focusChanged('swuhex-input'), value: "0x" + (0x40000 + this.iid).toString(16) })), h$1("ion-col", { size: "2" }, h$1("ion-button", { onClick: () => { this.setSymbol("swuhex", this.element.shadowRoot.querySelector('ion-input#swuhex-input').value); } }, "Set"))), h$1("ion-row", null, h$1("ion-col", { size: "4" }, h$1("ion-title", null, "ISWA ID")), h$1("ion-col", { size: "6" }, h$1("ion-input", { id: "iid-input", name: "iid-input", type: "number", onIonFocus: () => this.focusChanged('iid-input'), value: this.iid })), h$1("ion-col", { size: "2" }, h$1("ion-button", { onClick: () => { this.setSymbol("iid", this.element.shadowRoot.querySelector('ion-input#iid-input').value); } }, "Set"))), h$1("ion-row", null, h$1("ion-col", { size: "4" }, h$1("ion-title", null, "Unicode 8")), h$1("ion-col", { size: "6" }, h$1("ion-input", { class: "uni8", id: "uni-input", name: "uni-input", type: "text", pattern: symbol_min.re.symbol, onIonFocus: () => this.focusChanged('uni-input'), value: this.uni })), h$1("ion-col", { size: "2" }, h$1("ion-button", { onClick: () => { this.setSymbol("uni", this.element.shadowRoot.querySelector('ion-input#uni-input').value); } }, "Set"))), h$1("ion-row", null, h$1("ion-col", { size: "4" }, h$1("ion-title", null, "Code(s)")), h$1("ion-col", { size: "6" }, h$1("ion-input", { id: "unihex-input", name: "unihex-input", type: "text", onIonFocus: () => this.focusChanged('unihex-input'), value: this.codepoints() })), h$1("ion-col", { size: "2" }, h$1("ion-button", { onClick: () => { this.setSymbol("unihex", this.element.shadowRoot.querySelector('ion-input#unihex-input').value); } }, "Set")))))));
  }
...
export { Button as ion_button, Card as ion_card, Col as ion_col, Grid as ion_grid, Icon as ion_icon, Input as ion_input, Item as ion_item, Label as ion_label, Range as ion_range, RippleEffect as ion_ripple_effect, Row as ion_row, ToolbarTitle as ion_title, SgnwSymbol as sgnw_symbol, SgnwSymbolPicker as sgnw_symbol_picker };
