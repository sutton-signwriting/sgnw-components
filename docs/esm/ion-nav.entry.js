import { r as registerInstance, c as createEvent, h, a as getElement } from './index-f39b07ed.js';
import { g as getIonMode, c as config } from './ionic-global-0c7dacfa.js';
import { l as assert } from './helpers-aef58b6d.js';
...
import { l as lifecycle, t as transition, s as setPageHidden, L as LIFECYCLE_WILL_UNLOAD, a as LIFECYCLE_WILL_LEAVE, b as LIFECYCLE_DID_LEAVE } from './index-456f2a37.js';
...
const Nav = class {
  ...
  async componentDidLoad() {
    this.rootChanged();
    this.gesture = (await import('./swipe-back-85c97b1a.js')).createSwipeBackGesture(this.el, this.canStart.bind(this), this.onStart.bind(this), this.onMove.bind(this), this.onEnd.bind(this));
