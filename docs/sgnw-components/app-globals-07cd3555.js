import { B as BUILD, C as CSS, p as plt, w as win, a as promiseResolve, c as consoleDevInfo, H, d as doc, N as NAMESPACE } from './index-2ae47337.js';
...
const patchEsm = () => {
    ...
    if (BUILD.cssVarShim && !(CSS && CSS.supports && CSS.supports('color', 'var(--c)'))) {
        // @ts-ignore
        return __sc_import_sgnw_components(/* webpackChunkName: "polyfills-css-shim" */ './css-shim-e7d213b9.js').then(() => {
...
const patchBrowser = () => {
    ...
    if (!BUILD.safari10 && importMeta !== '') {
        ...
        if (BUILD.dynamicImportShim && !win.customElements) {
            ...
            // @ts-ignore
            return __sc_import_sgnw_components(/* webpackChunkName: "polyfills-dom" */ './dom-d5f595cc.js').then(() => opts);
        }
    }
